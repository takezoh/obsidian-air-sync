...
describe("Backend Module API v1 — JSON boundary", () => {
...
describe("Backend Module API v1 — error contract", () => {
...
describe("Backend Module API v1 — normalized object helpers", () => {
	...
	it("versions the API constant", () => {
		expect(BACKEND_MODULE_API_VERSION).toBe(1);
	});
});

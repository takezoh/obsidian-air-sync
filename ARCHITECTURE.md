...
| `fs/contracts/` | Shared public filesystem behaviour contracts plus the exact remote implementation-family catalog used by the central required-contract matrix and registry guard. |
